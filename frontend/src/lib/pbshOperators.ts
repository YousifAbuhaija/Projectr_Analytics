...
export const PBSH_CURATED: Record<string, PBSHMarketInfo> = {
  ...
  "Columbus, OH": {
    operators: [
      { operator: "ACC",         property_count: 4, dominant: true,  note: "University Commons, others near OSU" },
  ...
  "Ann Arbor, MI": {
    operators: [
      { operator: "Core Spaces", property_count: 2, dominant: false, note: "The Hub brand" },
  ...
  "Champaign, IL": {
    operators: [
      { operator: "Core Spaces", property_count: 2, dominant: true,  note: "The Hub brand" },
      { operator: "ACC",         property_count: 1, dominant: false },
    ],
    last_verified: "2025-01",
  },
  ...
  "College Park, MD": {
    operators: [
      { operator: "Core Spaces", property_count: 1, dominant: false, note: "The Hub at College Park" },
      { operator: "Greystar",    property_count: 2, dominant: false },
    ],
    last_verified: "2025-01",
  },
  ...
  "Austin, TX": {
    operators: [
      { operator: "ACC",         property_count: 5, dominant: true,  note: "Multiple complexes near UT Austin" },
  ...
  "Athens, GA": {
    operators: [
      { operator: "Landmark",    property_count: 2, dominant: false, note: "The Mark at Athens" },
      { operator: "Greystar",    property_count: 1, dominant: false },
    ],
    last_verified: "2025-01",
  },
...
export function concentrationStyle(level: ConcentrationLevel): {
  ...
  switch (level) {
    case "High":
      return { bg: "#fee2e2", text: "#991b1b", dot: "#ef4444", label: "High competition" };
    case "Medium":
      return { bg: "#ffedd5", text: "#9a3412", dot: "#f97316", label: "Moderate competition" };
    case "Low":
      return { bg: "#fef9c3", text: "#854d0e", dot: "#ca8a04", label: "Low competition" };
    default:
      return { bg: "#f0fdf4", text: "#15803d", dot: "#22c55e", label: "Clear market" };
  }
}
